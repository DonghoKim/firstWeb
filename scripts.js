...
const CONTRACT_ON_CHAINS = {
    ...
    5: '0xeD6bA72EfBe8D3FdaE119513Ad8c763E0B557099'
};
...
const onSubmitContractWrite = async (event) => {
    ...
    const encodedFunction = interface.encodeFunctionData(`${do_mine.name}`, [greeting]);
    console.log({ encodedFunction });
